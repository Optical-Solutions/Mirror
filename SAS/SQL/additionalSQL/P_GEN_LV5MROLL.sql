--------------------------------------------------------
--  DDL for Procedure P_GEN_LV5MROLL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "MAXDATA"."P_GEN_LV5MROLL" 
AS
x integer;
begin
...
from  maxdata.lv7mrll,
      maxdata.lv7loc
where lv7mrll.lv7loc_id = lv7loc.lv7loc_id and lv7loc.lv5loc_id IS NOT NULL
group by lv7mrll.ctree_or_loc_id, lv7loc.lv5loc_id, lv7mrll.category_level;
end ;

/

  GRANT EXECUTE ON "MAXDATA"."P_GEN_LV5MROLL" TO "MADMAX";
  GRANT EXECUTE ON "MAXDATA"."P_GEN_LV5MROLL" TO "MAXUSER";
