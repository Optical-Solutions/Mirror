--------------------------------------------------------
--  DDL for Procedure P_GEN_LV4MROLL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "MAXDATA"."P_GEN_LV4MROLL" 
AS
...
from  maxdata.lv7mrll,
      maxdata.lv7loc
where lv7mrll.lv7loc_id = lv7loc.lv7loc_id and lv7loc.lv4loc_id IS NOT NULL
group by lv7mrll.ctree_or_loc_id, lv7loc.lv4loc_id, lv7mrll.category_level;
end ;

/

  GRANT EXECUTE ON "MAXDATA"."P_GEN_LV4MROLL" TO "MADMAX";
  GRANT EXECUTE ON "MAXDATA"."P_GEN_LV4MROLL" TO "MAXUSER";
