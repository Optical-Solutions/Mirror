--------------------------------------------------------
--  DDL for Procedure P_LV3_FINC_ALL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "MAXDATA"."P_LV3_FINC_ALL" 
as
...
DELETE FROM maxdata.LV3FInc;
commit;
insert into maxdata.lv3finc
        (last_update,
         changed_by_batch,
         period,
         days_in_period,
...
group by lv4loc.lv3loc_id,
         lv4finc.period,
         lv4finc.cycle;

--Added by Maurice to populate period_start_date on 02/12/2001
Update maxdata.lv3finc set period_start_date
= ( select period_start_date from maxapp.period_lkup
where period_id = lv3finc.period and cycle_id = lv3finc.cycle
...
/
  ...
  GRANT EXECUTE ON "MAXDATA"."P_LV3_FINC_ALL" TO "MADMAX";
  GRANT EXECUTE ON "MAXDATA"."P_LV3_FINC_ALL" TO "MAXUSER";
