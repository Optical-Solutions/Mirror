--------------------------------------------------------
--  DDL for Procedure P_GEN_LV2MROLL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "MAXDATA"."P_GEN_LV2MROLL" 
AS
x integer;
begin
select periods_to_roll into x from maxapp.mmax_config;
insert into maxdata.lv2mrll
     (last_update,
      changed_by_batch,
      category_level,
      ctree_or_loc_id,
...
from  maxdata.lv7mrll,
      maxdata.lv7loc,maxapp.mmax_config
where lv7mrll.lv7loc_id = lv7loc.lv7loc_id and lv7loc.lv2loc_id IS NOT NULL
group by lv7mrll.ctree_or_loc_id, lv7loc.lv2loc_id, lv7mrll.category_level ;
end ;

/

  GRANT EXECUTE ON "MAXDATA"."P_GEN_LV2MROLL" TO "MADMAX";
  GRANT EXECUTE ON "MAXDATA"."P_GEN_LV2MROLL" TO "MAXUSER";
