--------------------------------------------------------
--  DDL for Procedure P_WL_VALIDATE_PERM_KPI_PA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "MAXDATA"."P_WL_VALIDATE_PERM_KPI_PA" (
...
/*----------------------------------------------------------------------------
$Log: 2360_p_wl_validate_perm_kpi_pa.sql,v $
Revision 1.9  2007/06/19 14:38:55  clapper
FIXID AUTOPUSH: SOS 1238247

Revision 1.5  2006/08/21 20:26:42  anchan
No change check-in

Revision 1.4  2006/08/18 16:54:23  anchan
S0372944: Fixed typo

Revision 1.3  2006/07/07 20:12:00  anchan
...
t_proc_name        	VARCHAR2(32) 		:= 'p_wl_validate_perm_kpi_pa';
...
WHEN in_object_type_cd IN(1,2,4) THEN
	...
	FROM maxdata.wlkf_kpi_field wlkf
