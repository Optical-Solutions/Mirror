--------------------------------------------------------
--  DDL for Procedure P_WKLY_SAS_BOP_EOP_SHRINK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ERIC"."P_WKLY_SAS_BOP_EOP_SHRINK" 
Is 
...
Select 
    ...
    ((Select 
      ...
      nvl((Ssr.Shrink_Reverse * -1),0) Sales_Shrink, 0 Sales_Sold_Price, 0 Purchases,  0 Transfers_Retail, 0 Adjustments_retail
    From
