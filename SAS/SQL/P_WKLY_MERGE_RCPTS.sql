--------------------------------------------------------
--  DDL for Procedure P_WKLY_MERGE_RCPTS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ERIC"."P_WKLY_MERGE_RCPTS" 
Is 
...
Values (P_Process_Id, 140,'Step 14:Merge/Insert Process Receipts:p_wkly_merge_rcpts',Sysdate,'sas_prod_complete','I');
Commit;
...
Using wkly_im_sas_receipts Src
...
Tgt.Receipts_Retail = Src.Retail_Price,
Tgt.Receipts_Cost = Src.Cost,
Tgt.receipts_qty = src.inven_move_qty
WHEN NOT MATCHED
...
Where Process_Step = 140 And Process_Id = P_Process_Id; 
commit;


Dbms_Job.Submit(Jobno, 'P_Wkly_merge_sales();', Sysdate, Null);
Commit;


END P_WKLY_merge_rcpts;     
