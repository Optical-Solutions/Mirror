--------------------------------------------------------
--  DDL for Procedure P_WKLY_IM_GROUP_TYPES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "ERIC"."P_WKLY_IM_GROUP_TYPES" 
Is 
...
(P_Process_Id,50,'Step 5:Group Inventory Extract (Site,Sku,Type,Yr,Wk):p_wkly_im_group_types',Sysdate,'wkly_im_sas_grp_types','I');
Commit;
...
Loop
  ...
  Decode(I.Inven_Move_Type, 'RECEIVING', 'RECEIVING',
    ...
    SUM(i.inven_move_qty *  nvl(i.retail_price,0)* (case when I.Inven_Move_Type = 'PHYSICAL' Then -1 else 1 end)) Retail_Price_v2,
  Sum(I.Inven_Move_Qty * (Case I.Inven_Move_Type 
    ...
    Where I.Inven_Move_Type In ('RECEIVING','TRANSFERS','RETURNS','SALES','ADJUSTMENT','PHYSICAL') 
...
/*
    ...
    Where (I.Inven_Move_Type In ('RECEIVING','TRANSFERS','RETURNS','SALES','ADJUSTMENT') 
    Or 
